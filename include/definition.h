...
#define SC_DEFAULT_DIR_PRIVILEGE (SC_DIR|SC_USR_PRIVILEGE_ALL|SC_GRP_PRIVILEGE_R|SC_GRP_PRIVILEGE_X|SC_OTH_PRIVILEGE_R|SC_OTH_PRIVILEGE_X)
#define SC_DEFAULT_FILE_PRIVILEGE (SC_USR_PRIVILEGE_R|SC_USR_PRIVILEGE_W|SC_GRP_PRIVILEGE_R|SC_OTH_PRIVILEGE_R)
